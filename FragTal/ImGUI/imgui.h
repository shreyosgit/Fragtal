...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsCustom(ImGuiStyle* dst = NULL); // custom imgui style
    ...
    IMGUI_API ImGuiID       DockBuilderSplitNode(ImGuiID id, ImGuiDir split_dir, float size_ratio_for_node_at_dir, ImGuiID* out_id_at_dir, ImGuiID* out_id_at_opposite_dir);
    ...
    IMGUI_API void          DockBuilderFinish(ImGuiID root_id);
